...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@flexternships/types': path.resolve(__dirname, 'src/flexternships/constraints/types'),
      '@flexternships/enums': path.resolve(__dirname, 'src/flexternships/constraints/enums'),
