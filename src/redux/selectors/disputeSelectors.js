...
export const disputesCountLoading = createSelector(disputeSelector, (dispute) => dispute.disputesCountLoading);

export const disputesCount = createSelector(disputeSelector, (dispute) => dispute.disputesCount);
