...
export const selectNDAData = createSelector(projectDetailsSelector, (state) => state?.ndaData);

export const selectContractData = createSelector(projectDetailsSelector, (state) => state?.contractData);
