...
import { checkReportFailure, checkReportRequest, checkReportSuccess, reportFailure, reportRequest, reportSuccess } from '../reducers/report';

  const checkIfReported = ({ data, onSuccess }) =>
    async (dispatch) => {
