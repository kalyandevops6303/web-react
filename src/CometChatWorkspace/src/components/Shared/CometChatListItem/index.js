...
const CometChatListItem = (props) => {
  let listIcon = null;
  if (props.iconURL) {
    listIcon = <div style={listItemIconStyle(props)} className="list_item_icon"></div>;
  }

  return (
    <div id={props.id} style={listItem(props)} className="list__item" onClick={props.onItemClick.bind(this)}>
      {listIcon}
