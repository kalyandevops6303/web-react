...
import { conversationActionStyle, groupButtonStyle, messageDeleteStyle } from './style.js';
      ...
      <li>
        ...
        >
          <img
            ...
            css={messageDeleteStyle()}
            src={this.state.deleteInProgress ? loadingIcon : deleteIcon}
          />
        </button>
      </li>
    );
