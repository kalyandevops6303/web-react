...
class CometChatConversationListItem extends React.PureComponent {
      ...
      if (this.state.enableHideDeletedMessages) {
        ...
        message =
          this.props.loggedInUser.uid === lastMessage.sender.uid
            ? `${Translator.translate('YOU_DELETED_THIS_MESSAGE', this.context.language)}`
      ...
      case enums.CUSTOM_TYPE_POLL:
        {
          ...
          message =
            lastMessage.receiverType === CometChat.RECEIVER_TYPE.GROUP ? `${sender} ${pollMessage}` : `${pollMessage}`;
        }
        break;
      ...
      case enums.CUSTOM_TYPE_DOCUMENT:
        {
          ...
          message =
            lastMessage.receiverType === CometChat.RECEIVER_TYPE.GROUP ? `${sender} ${docMessage}` : `${docMessage}`;
        }
        break;
      ...
      case CometChat.MESSAGE_TYPE.TEXT:
        {
          ...
          message =
            lastMessage.receiverType === CometChat.RECEIVER_TYPE.GROUP ? `${sender} ${textMessage}` : `${textMessage}`;
        }
        break;
      ...
      case CometChat.MESSAGE_TYPE.FILE:
        {
          ...
          message =
            lastMessage.receiverType === CometChat.RECEIVER_TYPE.GROUP ? `${sender} ${fileMessage}` : `${fileMessage}`;
        }
        break;
  ...
  getActionMessage = (message) => {
    ...
    const forString =
      message.action !== CometChat.ACTION_TYPE.MEMBER_JOINED && message.action !== CometChat.ACTION_TYPE.MEMBER_LEFT
        ? onEntity.name
        : '';
