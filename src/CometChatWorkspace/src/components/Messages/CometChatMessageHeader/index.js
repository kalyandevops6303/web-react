...
class CometChatMessageHeader extends React.Component {
  ...
  render() {
    ...
    if (this.context.type === CometChat.ACTION_TYPE.TYPE_USER) {
      ...
      presence = (
        <CometChatUserPresence status={this.state.presence} borderColor={this.props.theme.borderColor.primary} />
      );
    } else if (this.context.type === CometChat.ACTION_TYPE.TYPE_GROUP) {
    ...
    if (
      (this.context.type === CometChat.ACTION_TYPE.TYPE_USER && this.state.enableOneOnOneVoiceCall === false) ||
      (this.context.type === CometChat.ACTION_TYPE.TYPE_GROUP && this.state.enableGroupVoiceCall === false)
    ) {
      audioCallBtn = null;
    }
    ...
    if (
      (this.context.type === CometChat.ACTION_TYPE.TYPE_USER && this.state.enableOneOnOneVideoCall === false) ||
      (this.context.type === CometChat.ACTION_TYPE.TYPE_GROUP && this.state.enableGroupVideoCall === false)
    ) {
      videoCallBtn = null;
    }
    ...
    return (
      <div css={chatHeaderStyle(this.context)} className="chat__header">
        <div
          onClick={() => {
            this.props.sendData({ data1: avatar, data2: presence });
