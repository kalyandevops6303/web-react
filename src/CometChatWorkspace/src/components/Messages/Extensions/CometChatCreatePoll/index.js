...
class CometChatCreatePoll extends React.Component {
  ...
  createPoll = () => {
    ...
    if (question.length === 0) {
      this.setState({
        errorMessage: Translator.translate('INVALID_POLL_QUESTION', this.context.language),
      });
      return false;
    }
    ...
    if (firstOption.length === 0 || secondOption.length === 0) {
      this.setState({
        errorMessage: Translator.translate('INVALID_POLL_OPTION', this.context.language),
      });
      return false;
    }
            ...
            <table css={modalTableStyle(this.context)}>
              ...
              <tbody css={tableBodyStyle()}>
                ...
                <tr className="poll__question">
                  <td>
                    <label>{Translator.translate('QUESTION', this.context.language)}</label>
                  </td>
                  <td colSpan="2">
                    <input
                      type="text"
                      autoFocus
                      tabIndex="1"
                      placeholder={Translator.translate('ENTER_YOUR_QUESTION', this.context.language)}
                ...
                <tr className="poll__options">
                  ...
                  <td colSpan="2">
                    <input
                      type="text"
                      tabIndex="2"
                      placeholder={Translator.translate('ENTER_YOUR_OPTION', this.context.language)}
