...
export class FeatureRestriction {
  ...
  isHighlightMessagesEnabled = () =>
    new Promise((resolve) => resolve(this.UIKitSettings.highlightMessageFromModerators));
  ...
  isShareCopyForwardMessageEnabled = () =>
    new Promise((resolve) => resolve(this.UIKitSettings.shareCopyForwardMessage));
  ...
  isChangingGroupMemberScopeEnabled = () =>
    new Promise((resolve) => resolve(this.UIKitSettings.allowPromoteDemoteMembers));
  ...
  isCollaborativeWhiteBoardEnabled = () => {
    return new Promise((resolve) => {
      CometChat.isFeatureEnabled(FeatureRestriction.collaboration_whiteboard_enabled)
        .then(
          (response) => response && FeatureRestriction.isExtensionEnabled(FeatureRestriction.collaborationWhiteboard),
        )
