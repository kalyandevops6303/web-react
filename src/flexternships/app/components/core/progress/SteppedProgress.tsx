...
export default function SteppedProgress(props: SteppedProgressProps) {
  ...
  const progressStepVariants = cva(`w-[30px] h-[10px] gap-[4px] mr-2 rounded-[6px] border ${muted ? 'border-[#0185E480]' : 'border-[#0185E4]'}`, {
    variants: {
      variant: {
        filledPartial: muted ? `bg-[#0185E480] bg-[linear-gradient(90deg,_#0185E4_50%,_#fff_50%)]` : 'bg-[#0185E4] bg-[linear-gradient(90deg,_#0185E4_50%,_#fff_50%)]',
