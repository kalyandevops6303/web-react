      ...
      {options.map((option, index) => (
        <div
          ...
          className={`flex items-center p-4 rounded-lg border ${
            selectedOptions.includes(option) ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white'
        ...
        >
          <div
            className={`w-5 h-5 rounded border flex items-center justify-center mr-3 ${
              selectedOptions.includes(option) ? 'bg-blue-500 border-blue-500' : 'border-gray-300'
            }`}
          >
