      ...
      <div className="relative w-full min-w-[41.7rem] max-w-sm rounded-lg  bg-white pt-13 pr-8 pb-8 pl-10  shadow-lg">
        ...
        <div className="flex">
          <div className="height-full mr-10 flex min-w-30 w-30 items-center justify-center">
            ...
            <img src={TickGif} className=" w-full" width={100} height={100} alt="Draft Saved icon" />
          </div>
          <div>
            ...
            <p className=" text-xl font-medium text-grey-600">{duration} wk</p>
            <p className=" text-xs text-grey">Revised Estimated Duration (in weeks)</p>
