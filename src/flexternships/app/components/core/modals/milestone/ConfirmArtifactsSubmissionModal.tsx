...
export default function ConfirmArtifactsSubmissionModal(props: ConfirmArtifactsSubmissionModalProps) {
  const { onClose, isOpen, title, description, artifacts, onConfirm, isConfirmLoading } = props;
  return (
    <GenericModal isOpen={isOpen} onClose={onClose}>
      <div className="flex gap-x-6 pl-6 pr-8 pt-10 pb-6">
        <div className="flex flex-col justify-center items-center">
          <img className="w-48 h-48 object-cover" src={ChecklistGif} alt="checklist-gif" />
        </div>
...
type ConfirmArtifactsSubmissionModalProps = {
  onClose: () => void;
  onConfirm: () => void;
