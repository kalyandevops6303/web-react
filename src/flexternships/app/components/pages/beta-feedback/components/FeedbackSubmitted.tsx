...
interface FeedbackAlreadySubmittedProps {
  projectName: string;
  milestoneName: string;
}

const FeedbackAlreadySubmitted = ({ projectName, milestoneName }: FeedbackAlreadySubmittedProps) => {
    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-600 max-w-md">
          ...
          . You cannot submit feedback multiple times.
        </p>
