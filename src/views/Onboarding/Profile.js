...
const Profile = ({ tabNames, toggleTab }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      streetAddress: '',
      houseNumber: '',
      educationDetails: [{ educationInstitution: { label: '', value: '' }, education: { label: '', value: '' } }],
      linkedInLink: '',
      twitterLink: '',
      githubLink: '',
  ...
  const checkNestedObjectValues = (array) => {
    // eslint-disable-next-line
  ...
  const handleWeekDayCheckboxChange = (event) => {
    ...
    if (isChecked) {
      setSelectedWeekDays((prevSelectedWeekdays) => [...prevSelectedWeekdays, value]);
    } else {
      setSelectedWeekDays((prevSelectedWeekdays) => prevSelectedWeekdays.filter((day) => day !== value));
    }
  };

  const handleWeekendCheckboxChange = (event) => {
    const { value } = event.target;
    const isChecked = event.target.checked;

    if (isChecked) {
      setSelectedWeekendDays((prevSelectedWeekdays) => [...prevSelectedWeekdays, value]);
    } else {
      setSelectedWeekendDays((prevSelectedWeekdays) => prevSelectedWeekdays.filter((day) => day !== value));
    }
  };
          ...
          <CardBody>
            ...
            <Row className="mt-2 mb-3">
              <div
                ...
                onClick={() => {
                  if (checkNestedObjectValues(watch('educationDetails'))) {
                    append({ educationInstitution: { label: '', value: '' }, education: { label: '', value: '' } });
                  }
                }}
              >
                <UploadIconContainer>
          ...
          <CardBody>
            ...
            <Row className="mb-1 mt-2">
              <Col sm="6" md="6" lg="3">
                ...
                />
                {errors.weekdayStartTime && <FormFeedback>{errors.weekdayStartTime.label.message}</FormFeedback>}
              </Col>
              <Col sm="6" md="6" lg="3">
            ...
            <Row className="mt-2">
              <h5 className="m-0">Which working days of the week are you available?</h5>
            </Row>
            <Row className="mb-1 custom-checkbox-border">
              <div className="demo-inline-spacing">
                <div className="form-check form-check-inline checkbox-custom-margin">
                  <Input type="checkbox" value="Mon" name="weekWorkingDays" onChange={handleWeekDayCheckboxChange} />
                  <Label for="basic-cb-checked" className="form-check-label">
                    Mon
                  </Label>
                </div>
                <div className="form-check form-check-inline checkbox-custom-margin">
                  <Input type="checkbox" value="Tue" name="weekWorkingDays" onChange={handleWeekDayCheckboxChange} />
                  <Label for="basic-cb-unchecked" className="form-check-label">
                    Tue
                  </Label>
                </div>
                <div className="form-check form-check-inline checkbox-custom-margin">
                  <Input type="checkbox" value="Wed" name="weekWorkingDays" onChange={handleWeekDayCheckboxChange} />
                  <Label className="form-check-label">Wed</Label>
                </div>
                <div className="form-check form-check-inline checkbox-custom-margin">
                  <Input type="checkbox" value="Thu" name="weekWorkingDays" onChange={handleWeekDayCheckboxChange} />
                  <Label className="form-check-label">Thu</Label>
                </div>
                <div className="form-check form-check-inline">
                  <Input type="checkbox" value="Fri" name="weekWorkingDays" onChange={handleWeekDayCheckboxChange} />
            ...
            <Row className="mt-2">
              <h5 className="m-0">Which working days of the weekend are you available?</h5>
            </Row>
            <Row className="mb-1 custom-checkbox-border">
              <div className="demo-inline-spacing">
                <div className="form-check form-check-inline checkbox-custom-margin">
                  <Input type="checkbox" value="Sat" name="weekendWorkingDays" onChange={handleWeekendCheckboxChange} />
                  <Label for="basic-cb-checked" className="form-check-label">
                    Sat
                  </Label>
                </div>
                <div className="form-check form-check-inline">
                  <Input type="checkbox" value="Sun" name="weekendWorkingDays" onChange={handleWeekendCheckboxChange} />
                  <Label for="basic-cb-unchecked" className="form-check-label">
                    Sun
                  </Label>
                </div>
