...
const InternXobinHiringItem = ({ listing }) => {
  return (
    <Card className="w-75">
      ...
      <CardBody>
        <CardText>
          Thank you for showing interest in Trumio. Click on
          <b> Take Assessment, </b>
          it will take you the Assessment platform where you need to provide your same email used to register Trumio,
          Name and Roll No. It will then take you to the assessment page.
        </CardText>
