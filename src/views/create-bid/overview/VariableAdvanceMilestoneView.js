                ...
                <Row className="d-flex justify-content-between">
                  ...
                  <Col sm="12" md="12" lg="4" className="d-flex justify-content-between me-1">
                    <div>
                      ...
                      <p className="fw-bold font-medium-1 text-end mt-50 mb-0">
                        ...
                        <Row className="d-flex justify-content-between align-items-center w-100">
                          ...
                          <Col sm="12" md="12" lg="4" className="d-flex justify-content-between me-1 ps-5">
                            <div>
                              ...
                              <p className="fw-bold font-medium-1 mt-50 mb-0 text-end">
                                {useWatch({ control, name: 'milestones' })
                                  [milestoneIndex]?.workers?.filter((worker) => worker.isChecked && worker.duration)
                            ...
                            <div className="ms-2">
                              ...
                              <p className="fw-bold font-medium-1 mt-50 mb-0 text-end">
                                {useWatch({ control, name: 'milestones' })
                                  [milestoneIndex]?.workers?.filter(
                                    (worker) => worker.isChecked && worker.duration && worker.hours,
                                  )
                            ...
                            <div>
                              ...
                              <p className="fw-bold font-medium-1 mt-50 mb-0 text-end">
                                ...
                                {useWatch({ control, name: 'milestones' })
                                  ...
                                  .reduce(
                                    (sum, worker) =>
                                      sum + worker.duration * worker.hours * worker.otherDetails.hourly_rate,
                                    0,
                                  )}
                              </p>
                            </div>
                                            ...
                                            <div className="d-flex align-items-center">
                                              <div className="form-check form-check-inline checkbox-custom-margin">
                                                <Input
                                                  ...
                                                  onChange={(e) => {
                                                    if (e.target.checked) {
                                                      workerField.onChange(
                                                        workerField.value.map((w) => {
                                              ...
                                              <Label for={worker.role} className="form-check-label">
                                                {worker.role}
                                              </Label>
                                            </div>
                                          </Col>
                                            ...
                                            <Row>
                                                  ...
                                                  <Input
                                                    ...
                                                    onChange={(e) => {
                                                      workerField.onChange(
                                                        workerField.value.map((w) => {
                                                          if (w.role === worker.role) {
                                                            return { ...w, duration: Number(e.target.value) };
                                                          } else {
                                                            return w;
                                                          }
                                                        }),
                                              ...
                                              <Col sm="12" md="6" lg="6">
                                                <InputGroup className="input-group-merge">
                                                  <Input
                                                    ...
                                                    onChange={(e) => {
                                                      workerField.onChange(
                                                        workerField.value.map((w) => {
                                                          if (w.role === worker.role) {
                                                            return { ...w, hours: Number(e.target.value) };
                                                          } else {
                                                            return w;
                                                          }
                                                        }),
                                                  ...
                                                  {getValues('milestones')[milestoneIndex].workers?.find(
                                                    (w) => w.role === worker.role,
                                                  )?.hours > 0 && <InputGroupText className="ps-0">h</InputGroupText>}
                                                </InputGroup>
                                              </Col>
                                            </Row>
                                          </Col>
