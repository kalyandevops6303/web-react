    ...
    <Modal isOpen={modal} contentClassName="custom-modal-style" className="modal-dialog-centered modal-lg">
      ...
      <ModalBody>
        <div className="d-flex justify-content-between pr-1">
          ...
          />
          <div>
            <h2 className="fw-normal">Request Submitted</h2>
            <p className="fw-light w-75 mt-2">Your request to create a Trumio Club account has been received. </p>
            <p className="fw-light w-75 mt-2">We will get back to you shortly. </p>
          </div>
        </div>
