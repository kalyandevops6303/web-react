...
const SendInvitationModal = ({ modal, toggleModal, selectedTalents }) => {
      ...
      >
        ...
        <ModalBody>
          <div className="px-3">
            ...
            <InviteUsersListContainer>
              {selectedTalents.map((talent) => (
                <Row key={talent.id} className="d-flex align-items-center mb-2 w-100">
                  <Col sm="12" md="8" lg="6">
                    <div className="d-flex align-items-center">
                      <div className="user-pic p-25 me-2">
                        <User size={28} />
                      </div>
                      <p className="font-medium-1 fw-bold m-0">{talent.name}</p>
                    </div>
                  </Col>
                  <Col sm="12" md="4" lg="6">
                    <div className="d-flex align-items-center">
          ...
          <div className="d-flex justify-content-end mb-2 me-1 mt-3">
            ...
            <Button color="primary" onClick={() => setInvitationSentModal(true)}>
              Invite
            </Button>
          </div>
        </ModalBody>
