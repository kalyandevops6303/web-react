...
const WithdrawnProjectCardForTalent = ({ accordionName, data, className }) => {
...
export default WithdrawnProjectCardForTalent;

WithdrawnProjectCardForTalent.propTypes = {
  data: Proptypes.object,
  className: Proptypes.string,
  accordionName: Proptypes.string,
};

WithdrawnProjectCardForTalent.defaultProps = {
  data: {},
  className: '',
  accordionName: '',
};
