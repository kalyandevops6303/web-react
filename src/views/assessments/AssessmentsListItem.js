  ...
  return (
    <>
      <tr>
        ...
        <td>{assessment.completed_date && getDisplayDate(assessment.completed_date)}</td>
            ...
            <div className="d-flex gap-1 align-items-center justify-content-between">
              {retakeAvailable(assessment) ? (
                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div className="cursor-pointer" id="days-left">
                    <Tag hasNew={false} count={daysLeftForRetake(assessment) + ' days left'} noMargin={true} />
                  </div>
      ...
      {showSections &&
        assessment.sections &&
        Object.entries(assessment.sections).map(([key, value]) => (
          <tr>
            <td></td>
            <td></td>
            <td>{key}</td>
      ...
      <Modal
        ...
        contentClassName="custom-modal-style modal-wide"
        ...
        <ModalBody>
          <CardBody className="px-3">
            <CardTitle className="modal-heading">
              Preparing Your Assessment - <span className="text-warning">{assessment.assessment_name}</span>
            </CardTitle>
            <CardText className="modal-body-text fw-light w-76">
            ...
            <div className="d-flex flex-wrap row">
              {assessmentModalPoints.map((point) => (
                <div className="col-6 p-1 d-flex align-items-center gap-1">
                  <ActionContainer>{point.image && point.image}</ActionContainer>
          ...
          <div className="d-flex gap-1 me-1 justify-content-end">
            {!assessmentLinkLoading && (
              <Button outline color="primary" onClick={() => setShowAssessmentModal(false)}>
                Not Now
              </Button>
            )}
            <a href={assessmentLinkLoading ? '#' : assessmentLink} onClick={() => setShowAssessmentModal(false)}>
