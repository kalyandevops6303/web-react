          ...
          <div className="d-flex justify-content-between pr-1">
            ...
            <div>
              ...
              <CardText className="modal-body-text fw-light w-76">
                <div>
                  {' '}
                  <span className="fw-bolder mb-50">1. </span> This action can not be undone
                </div>
              </CardText>
              ...
              <CardText className="modal-body-text fw-light w-76">
                <div>
                  {' '}
                  <span className="fw-bolder mb-50">2. </span> You’ll get refund for future milestones only.
                </div>
              </CardText>
              ...
              <CardText className="modal-body-text fw-light w-76">
                <div>
                  {' '}
                  <span className="fw-bolder mb-1">3. </span>The talent/team will be paid for completed and ongoing
                  milestones.
                </div>
              </CardText>
              ...
              <CardText className="modal-body-text fw-light w-76">
                <div>
                  {' '}
                  <span className="fw-bolder">4. </span> Amount against dispute, will be kept on hold until resolved.
                </div>
              </CardText>
              {workers?.entity_type && (
                <CardText className="modal-body-text fw-light w-76">
              ...
              <section className="grid stats">
                <div style={{ width: '13rem' }}>
                  <CardText className="text-truncate value mb-25">{data?.pay_type?.fixed_cost}</CardText>
