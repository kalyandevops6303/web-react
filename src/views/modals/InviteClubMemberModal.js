  ...
  const loadNewBestTalents = () => {
    dispatch(
      getBestTalents(
        ...
        listData?.metadata?.current_page + 1,
        10,
        listData?.data,
      ),
    );
          ...
          <Row>
            <Col sm="12" md="12" lg="9">
              <InputGroup className="input-group-merge mt-1">
                ...
                <Input
                  placeholder="Enter talent or team member name"
                  value={searchValue}
              ...
              <TabPane>
                <TableContainer id="scrollableDiv" style={{ maxHeight: '18rem', overflowY: 'auto' }}>
                  <InfiniteScroll
                    ...
                    hasMore={listData?.metadata?.has_next_page}
...
export default InviteClubMemberModal;
InviteClubMemberModal.propTypes = {
