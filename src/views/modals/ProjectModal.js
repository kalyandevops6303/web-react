...
<PermissionWrapper permissions={appPermissions} permissionName={['MARKETPLACE.ALL_LISTINGS.CREATE_BID']}>{(data?.status === projectStatusEnum.OPEN || data?.status === projectStatusEnum.IN_REVIEW) &&
