...
import { acceptBidChange } from '../../redux/actions/projectDetailsAction';

const AcceptBidModal = ({ modal, toggleModal }) => {
  ...
  const onSubmit = () => {
    ...
    // };
    dispatch(acceptBidChange({ id: 123 }));
  };
  ...
  return (
    <Modal isOpen={modal} contentClassName="custom-modal-style" className="modal-dialog-centered">
      ...
      <ModalBody className="pt-0 px-5">
        <h2 className="font-large-1 text-center mb-2">Accept Bid Change</h2>
