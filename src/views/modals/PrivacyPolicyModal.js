        ...
        <PrivacyPolicyModalWrapper>
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              discontinue using the Site. Our Site Terms are expressly incorporated herein by reference and made a part
              of this Policy. By using the Site, You signify that You agree to the terms of this Policy as well as to
              Our Site Terms.
            </p>
          </section>
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              periodically as its terms may change from time to time. Your continued use of the Site modifications to
              this Policy will constitute Your agreement to abide and be bound by the modified Policy terms.
            </p>
          </section>
          ...
          <section className="mb-2">
            ...
            <span>
              <p className="mb-50">
                ...
                obligations, protect the security of our systems and our customers, or fulfill other legitimate
                interests.
              </p>
              <p className="mb-50">
              ...
              <tbody>
                ...
                <tr className="row-bottom-border">
                  <td className="row-content-top">
                    ...
                    <p>
                      ...
                      Account information includes your name, mobile phone and email address and any other
                  ...
                  <td className="row-left-border">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        by Company and others, and provide news and information we think will be of interest to you;
                      </li>
                ...
                <tr className="row-bottom-border">
                  <td className="row-content-top">
                    ...
                    <p>
                      ...
                      address that may be provided by you or through the your use of the service, through cookies or
                      other tracking technologies or other third parties.
                    </p>
                  </td>
                  <td className="row-left-border">
                    <p>We use this information to</p>
                ...
                <tr className="row-bottom-border">
                  <td colSpan={2}>
                    ...
                    <p>
                      When you access or use our services, we may automatically collect information about you, as
                      follows:
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td className="row-right-border row-bottom-border">
                    ...
                    <p>
                      ...
                      including the hardware model, operating system and version, unique device identifiers, Company app
                      version, mobile network information, and whether notification and location permissions are
                      enabled.
                    </p>
                  </td>
                </tr>
                <tr>
                  <td className="row-right-border row-bottom-border">
                    ...
                    <p>
                      ...
                      features of our mobile applications or otherwise consent to the collection of this information.
                ...
                <tr>
                  <td className="row-right-border row-bottom-border">
                    ...
                    <p>
                      ...
                      web beacons (collectively, “Cookies”). Most browsers are set to accept cookies. To learn more
                      about how we use Cookies and how to manage your preferences, please read our Cookie Policy.
                    </p>
                  </td>
                </tr>
                <tr>
                ...
                <tr className="row-bottom-border">
                  <td className="row-right-border">
                    ...
                    <p>
                      User-generated content, (e.g., community posts, feedback and job postings), photographs, examples
                      of your work, information on work previously performed via the Service and outside the Service,
                      skills, rates and earnings information.
                    </p>
                  </td>
                </tr>
                <tr className="row-bottom-border">
          ...
          <section className="mb-2">
            ...
            <div className="ms-2 d-flex mb-1">
              ...
              CLICK STREAM DATA.&nbsp; When You visit Our website We may also collect click stream data, including but
              not limited to server address, domain name, and other items (“Click Stream Data”). This information can be
            ...
            <div className="ms-2 d-flex mb-1">
              ...
              web beacons, but they can be rendered ineffective through use of the apparent browser modification
              settings to notify You each time a web cookie is tendered, which will permit You to decline all such
              cookies on an individual basis.
            </div>
            <div className="ms-2 d-flex mb-1">
              <span className="me-1">D.</span>
              MOBILE DEVICE DATA.&nbsp; If You access Site or services using a mobile device, the information relating
              to Your mobile device, including the device ID, model, manufacturer, operating system, version
              information, and IP address, may be collected.
            </div>
            <div className="ms-2 d-flex mb-1">
            ...
            <div className="ms-2 d-flex mb-1">
              ...
              PUSH NOTIFICATIONS.&nbsp; We may send You push notifications to Your mobile device, if You choose to
              receive them. To opt out of these types of communications, You may turn them off in Your device’s push
            ...
            <div className="ms-2 d-flex">
              ...
              <div>
                <p className="mb-50">
                  THIRD PARTY ANALYTICS PROVIDERS AND SIMILAR VENDORS.&nbsp; Company works with (or may in the future
                  work with) ad networks, ad agencies, analytics service providers and other vendors to provide us with
                  information regarding traffic on the Service, including pages viewed and the actions taken when
                  visiting the Service; to serve our advertisements on other websites, within mobile apps and elsewhere
                  online; and to provide us with information regarding the use of the Service and the effectiveness of
                  our advertisements. Our service providers may collect certain information about your visits to and
                  activity on the Service as well as other websites or services, they may set and access their own
                  tracking technologies on your device (including cookies and web beacons), and may use that information
                  to show you targeted advertisements. Some of these parties may collect Personal Information when you
                  visit the Service or other online websites and services. We may also share certain Non-Identifying
                  Information with these parties, including Hashed Information, in connection with the services they
                  provide to us. If you wish to opt out of interest-based advertising from participating companies,
                  click here. You must opt out on each device and each browser where you want your choice to apply. If
                  you choose to opt out, please note you will continue to receive advertisements, but they may be less
                  relevant to you.
                </p>

                <p>
                  While we may use a variety of service providers to perform advertising services, some of these
                  companies are members of the Network Advertising Initiative (“NAI”) or the Digital Advertising
                  Alliance (“DAA”) Self-Regulatory Program for Online Behavioral Advertising. You may want to visit
          ...
          <section className="mb-2">
            ...
            <ul className="mt-1">
              ...
              <li>
                ...
                acquisition, divestiture, bankruptcy, dissolution, or other transaction or proceeding involving sale,
                transfer or divestiture of all or a portion of our business or assets to another company, to the extent
                permitted under applicable law;
              </li>
              <li>
                between and among Company and our current and future parents, affiliates, subsidiaries and other
            ...
            INFORMATION. Certain Personal Information of Yours may be disclosed as a matter of course as a result of
            Your use on the Site, such as interactions You engage in. YOU ASSUME ALL RESPONSIBILITY FOR ALL PRIVACY
            DISCLOSURES OR OTHER HARM RESULTING FROM YOUR VOLUNTARY DISCLOSURE OF YOUR PERSONAL INFORMATION.
            <div className="mt-1">
              <div className="ms-2">
                <div className="d-flex mb-1">
                  <span className="me-1">7.1&nbsp;</span>
                  ADDITIONAL USES OF PERSONAL INFORMATION PROVIDED.&nbsp; We may use the Personal Information You
                  provide and any General Information We receive from You to provide products and services to You and
                  other visitors and/or users, including, but not limited to, the following:
                </div>
                ...
                <div className="ms-3 d-flex mb-1">
                  ...
                  products and services and deliver to You the type of content, features and promotions that You are
                  most interested in.
                </div>
                <div className="ms-3 d-flex mb-1">
                  <span className="me-1">D.</span>
                ...
                <div className="ms-3 d-flex mb-1">
                  ...
                  contact information, email address, with Our service providers that provide services on Our behalf,
                  such as our merchant processors.
                </div>
                <div className="d-flex mb-1">
                  <span className="me-1">7.2&nbsp;</span>
                  OTHER USES.&nbsp; To the extent that You provide Your information or other details with other users,
                  including on elements or aspect of Our Site that are created by other users, Your information will
                  also be shared with them. This will include:
                </div>
                <div className="ms-3 d-flex mb-1">
                  <ul>
          ...
          <section className="mb-2">
            ...
            <p>
              We do not track users or customers across third party websites to provide targeted advertising and
              therefore our Site does not respond to Do Not Track (DNT) signals. However, some third party sites may
              keep track of Your browsing activities when they serve You content, which enables them to tailor what they
              present to You. If You are visiting such sites, Your browser may allow You to set the DNT signal on Your
              browser so that third parties (particularly advertisers) know You do not want to be tracked.
            </p>
            <p>
              ...
              Third parties cannot collect any other Personal Information of Yours from Our website unless You provide
              it to them directly.
            </p>
          </section>
          ...
          <section className="mb-2">
            ...
            <div className="ms-2">
              <div className="d-flex mb-1">
                ...
                parties may intercept and use that information. While Company strives to protect Your Personal
                Information and privacy, We cannot guarantee the security of any information You disclose online. By
                using this site, You expressly acknowledge and agree that We do not guarantee the security of any data
                provided to or received by Us through this Site and that any Personal Information, General Information,
                or other data or information received from You through the Site is provided to Us at Your own risk,
                which You expressly assume.
              </div>
              <div className="d-flex mb-1">
                <span className="me-1">9.2&nbsp;</span>
                LAW ENFORCEMENT.&nbsp; We reserve the right to disclose all information We may have obtained about You
                to law enforcement, to prevent fraud or abuse, or to protect Our legal rights.
              </div>
              <div className="d-flex mb-1">
          ...
          <section className="mb-2">
            ...
            <div className="ms-2">
              <div className="d-flex mb-1">
                ...
                Personal registration information submitted by a person under the age of 18 will not be accepted.
                Company is committed to protecting the privacy of children and has no intention of collecting personal
                data from children under the age of 18. We encourage parents and guardians of children under 18 to
                regularly check and monitor their children’s use of e-mail and other activities online.
              </div>
              <div className="d-flex mb-1">
                ...
                Our content specifically at children under 13 years of age. We understand and are committed to
                respecting the sensitive nature of children’s privacy online. If We learn or have reason to suspect that
                a Site user is under age 13, We will promptly delete all Personal Information in that user’s account. If
                You are a parent or guardian of a child under the age of 13 has become a member of the Site has
                otherwise shared Personally Identifiable Information with us, please contact Us using Our contact
                information below to have the child’s account terminated and deleted.
              </div>
            </div>
          </section>
          ...
          <section className="mb-2">
            ...
            <div className="ms-2">
              <div className="d-flex mb-1">
                ...
                carrying out the work as agreed with Us and will be required to keep the information confidential. We
                will encourage Our service partners to adopt and post privacy policies. However, the use of Your
                Personal Information by Our service partners is governed by the privacy policies of those service
                partners and is not subject to Our control.
              </div>
              <div className="d-flex mb-1">
                ...
                Your consent for security purposes, when required by law, requested by law enforcement, and/or to
                prevent imminent harm to any person or entity. We will disclose Personal Information or General
                Information upon receipt of a court order or subpoena in any civil matter, criminal matter and/or
                administrative, legislative, or other proceeding of any type or nature, and will to cooperate with a law
                enforcement investigations, which may include responding to requests and court orders from jurisdictions
                outside the United States. We fully cooperate with law enforcement agencies in identifying those who use
                Our services for illegal activities. We reserve the right to report to law enforcement agencies any
                activities that We in good faith believe to be unlawful, as determined in Our sole discretion. Release
                of Your Personal Information or General Information to any person or entity under any circumstances
                shall be based on a determination made solely by us, exercising Our own discretion, permission for which
              ...
              <div className="d-flex mb-1">
                ...
                third party sites may take You outside Our service and off the Company’s Site and are beyond Our
                control. This includes links from partners that may use Company’s logos as part of a co-branding
                agreement. The sites may have their own separate privacy policies, and Company is not liable for the
                content and activities of those sites. Your visits and access to such sites is at Your own risk. Please
                note that those other sites may send their own cookies to users, collect data, or solicit Personal
                Information; and the privacy policies of those sites may collect greater, lesser, different, or other
                types of information than our Site may.
              </div>
            </div>
          </section>
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              contacting us as outlined in the “Contact Us” section below, or submitting a request here. Depending on
              your location, you may also opt out of targeted advertising here.
            </p>
            <p>
              Only you, or a person that you authorize to act on your behalf, may make a request related to your
              personal information. In the case of access and deletion, your request must be verifiable before we can
              fulfill such request. Verifying your request will require you to provide sufficient information for us to
              reasonably verify that you are the person about whom we collected personal information or a person
              authorized to act on your behalf. We will only use the personal information that you have provided in a
              verifiable request in order to verify your request. We cannot respond to your request or provide you with
              personal information if we cannot verify your identity or authority. Please note that we may charge a
              reasonable fee or refuse to act on a request if such request is excessive, repetitive or manifestly
              unfounded. You will not receive any discriminatory treatment by us for the exercise of your privacy
              rights.
            </p>
          </section>
          ...
          <section className="mb-2">
            <h5>
              13. FOR INDIVIDUALS LOCATED IN THE EUROPEAN ECONOMIC AREA (EEA), UNITED KINGDOM (UK), OR SWITZERLAND:
            </h5>
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              California may request a list of all third parties to which we have disclosed certain information during
              the preceding year for those third parties’ direct marketing purposes.
            </p>
            <p>
              <span className="underline-text">
                California Consumer Privacy Act (CCPA)/California Privacy Rights Act (CPRA):
              </span>{' '}
              The CCPA, as amended by the CPRA, provides California residents and/or their authorized agents with
              specific rights regarding the collection and processing of their personal information.
            </p>
            <p>
              <span className="underline-text">Your Right to Know:</span> California residents have the right to request
              that we disclose the following information to you about our collection and use of your personal
              information over the past twelve (12) months. We may ask you to provide certain information to identify
              yourself so that we may compare it with our records in order to verify your request. Upon verification, we
            ...
            <ul>
              ...
              <li>
                Our business or commercial purpose for collecting or “selling” your personal information as defined by
                the CCPA.
              </li>
              <li>
                The categories of third parties to whom we have sold or shared your personal information, if any, and
                the categories of personal information that we have shared with each third-party recipient.
              </li>
            </ul>
            <p>
              <span className="underline-text">
            ...
            <p>
              ...
              behavioral advertising or profiling, you may opt-out of such sharing at any time by submitting a request
              as directed on the homepage of our website or by contacting us using the information in the “Contact Us”
              section below.
            </p>
            <p>
              ...
              business purposes under the CCPA, as amended by the CPRA. Please note that we do not use sensitive
              personal information other than as necessary to perform the Services or as specifically permitted under
              the CCPA.
            </p>
            <p>
              <span className="underline-text">Your Right to Delete:</span> California residents have the right to
              request that we delete any of the personal information collected from you and retained by us, subject to
              certain exceptions. We may ask you to provide certain information to identify yourself so that we may
              compare it with our records in order to verify your request. Once your request is verified and we have
              determined that we are required to delete the requested personal information in accordance with the CCPA,
              we will delete, and direct our third-party service provides to delete, your personal information from
              their records. Your request to delete personal information that we have collected may be denied if we
              conclude it is necessary for us to retain such personal information under one or more of the exceptions
              listed in the CCPA.
            </p>
            <p>
              ...
              maintain about you, taking into account the nature of the personal information and the purposes for which
              we are processing such personal information. We will use commercially reasonable efforts to correct such
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              emailing {supportEmail}. Please note we will take reasonable steps to verify your identity and the
              authenticity of the request. Once verified, we will maintain your request in the event our practices
              change.
            </p>
          </section>
          ...
          <section className="mb-2">
            ...
            <p>
              <span className="underline-text">Your Right to Portability:</span> You have to right to obtain a copy of
              the personal information we maintain and process about you in a portable and, to the extent technically
            ...
            <p>
              <span className="underline-text">Your Right to Correct:</span> You have the right to request that we
              correct inaccuracies in the personal information we maintain or process about you, taking into
              consideration the nature and purpose of such processing.
            </p>
            <p>
            ...
            <p>
              ...
              advertising from us and to better understand how you interact with our Services. Through the use of
              cookies, we may also make available certain personal information to third parties for targeted
              advertising. You may opt-out from such targeted advertising under Applicable State Law by clicking here.
            </p>
          </section>
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              {supportEmail} with the subject “Data Privacy Request Appeal” to provide us with details about why you are
              appealing the decision. If you have an unresolved privacy or data use concern that we have not addressed
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              reasonable administrative, technical, and physical safeguards designed to protect personal information
              that we receive against accidental, unlawful, or unauthorized destruction, loss, alteration, access,
              disclosure or use.
            </p>
          </section>
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              information, and the accidental loss or destruction of, or damage to, personal information, consistent
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              Frameworks (“Privacy Shield”) with respect to the Personal Information that they receive in reliance on
              the Privacy Shield. Our Privacy Shield certification is available at https://www.privacyshield.gov/list.
              To learn more about the Privacy Shield program, please visit https://www.privacyshield.gov . In light of
              the judgment of the Court of Justice of the EU in Case C-311/18, Company does not rely on the Privacy
              Shield as a legal basis for the transfer of personal data, however, when Company or one of its affiliates
              receives Personal Information under the Privacy Shield and then transfers it to a third party service
              provider acting as an agent on their behalf, Company or its affiliate may have certain responsibility
              under the Privacy Shield if both (i) the agent processes the information in a manner inconsistent with the
              Privacy Shield and (ii) Company or its affiliate is responsible for the event giving rise to the damage.
            </p>
            <p>
              ...
              with Company, your issue or complaint is not resolved, Company and the above-named affiliates have agreed
              to participate in the Privacy Shield independent dispute resolution mechanisms listed below, free of
              charge to you. PLEASE CONTACT UPWORK FIRST.
            </p>
            <p>
              ...
              operated by JAMS. If you do not receive timely acknowledgment of your complaint, or if your complaint is
              not satisfactorily addressed, please visit https://www.jamsadr.com/eu-us-privacy-shield for more
          ...
          <section className="mb-2">
            ...
            <p>
              ...
              out, or delete or modify Your Personal Information, by visiting Our website registration page and
              following the instructions provided. We encourage You promptly to update Your Personal Information when it
              changes.
            </p>
          </section>
