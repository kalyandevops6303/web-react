...
const RatingSubmitSuccessModal = ({ modal, toggleModal }) => (
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="w-100">
          ...
          <div className="d-flex align-items-center mt-50">
            <Avatar img={defaultAvatar} imgHeight="38" imgWidth="38" className="me-1" />
            <div>
              <p className="fw-bold font-medium-1 mb-0">Edgar Jones</p>
              <p className="mb-0">Red Fort Software</p>
            </div>
          </div>
