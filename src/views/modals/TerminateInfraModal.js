      ...
      <ModalBody>
        <TerminateModalWrapper>
          <div className="d-flex justify-content-between pr-1">
            ...
            <div>
              <CardTitle className="modal-heading">Infrastructure Deletion</CardTitle>
              ...
              <CardText className="modal-body-text fw-light w-76">
                <span className="fw-bolder mb-50">2.</span> All the services allotted to this project will be destroyed.
              </CardText>
            </div>
          </div>
          <div className="d-flex gap-1 mt-3 justify-content-end">
            <Button disabled={isTerminating} outline color="danger" onClick={onConfirm}>
