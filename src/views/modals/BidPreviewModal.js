...
const BidPreviewModal = ({ onReject, onAccept, modal, selectedTimeline, toggleModal }) => {
  ...
  const isLoading = useSelector((state) => state.projectDetails.getbidSnapshotLoading);
  ...
  useEffect(() => {
    dispatch(getBidSnapshot({ snapshot_id: selectedTimeline?.snapshot_id }));
  }, []);
                                          ...
                                          <Row className="mt-1" key={worker?.role}>
                                            <Col sm="12" md="12" lg="4">
                                              <div className="d-flex align-items-center">
                                                <Avatar
                                                  img={
                                                    worker?.image_uri?.length > 0 ? worker?.image_uri : defaultAvatar
                                                  }
                                                  imgHeight="32"
                                                  imgWidth="32"
                                                />
                                                {worker?.user_id ? (
                                                  ...
                                                  <p className="fw-bolder to-be-assigned-text m-0 ms-50">
                                                    To be assigned
                                                  </p>
                                                )}
                                              </div>
