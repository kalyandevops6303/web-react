...
const milestoneSubmissionFileUploadService = ({ project_id, milestone_id, file_name }) =>
  DataService.get(
...
const saveDraftMilestoneService = (milestone_id, data) =>
  DataService.post(`${API.projectMilestones.saveDraftMilestone}?milestone_id=${milestone_id}`, data);

const getDraftMilestoneService = (milestone_id) =>
  DataService.get(`${API.projectMilestones.getDraftMilestone}?milestone_id=${milestone_id}`);

const deleteDraftMilestoneService = (milestone_id, data) =>
  DataService.delete(`${API.projectMilestones.deleteDraftMilestone}?milestone_id=${milestone_id}`, data);
...
export {
  ...
  milestoneSubmissionFileUploadService,
