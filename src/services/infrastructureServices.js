...
const createInfraService = (project_id, services_selected = []) => DataService.post(`${API.projectDetails.createInfra}?project_id=${project_id}`, services_selected)

const terminateInfraService = (project_id) => DataService.put(`${API.projectDetails.terminateInfra}?project_id=${project_id}`)
