...
const deleteAssessmentService = ({ assessment_id }) => DataService.delete(API.assessments.delete_assessment + `?assessment_id=${assessment_id}`);
...
const addAssessmentService = ({ assessment_name, assessment_id }) => DataService.put(API.assessments.add_assessment + `?assessment_name=${assessment_name}&assessment_id=${assessment_id}`);
...
const editAssessmentService = ({curr_assessment_name, prev_assessment_id, curr_assessment_id}) => DataService.put(API.assessments.edit_assessment + `?curr_assessment_name=${curr_assessment_name}&prev_assessment_id=${prev_assessment_id}&curr_assessment_id=${curr_assessment_id}`);
